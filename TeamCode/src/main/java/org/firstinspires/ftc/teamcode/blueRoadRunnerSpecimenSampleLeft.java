...
@Autonomous(name = "Blue Left Speci and Sample", group = "A")
public class blueRoadRunnerSpecimenSampleLeft extends LinearOpMode {
    DcMotor testMotor;
    DcMotor slideMotor;
    Servo wrist;
    CRServo intakeLeft;
    ...
    public void runOpMode() {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPos)
                .splineTo(new Vector2d(8,38),Math.toRadians(180),SampleMecanumDrive.getVelocityConstraint(50, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory traj2 = drive.trajectoryBuilder(traj1.end())
                .strafeLeft(6.7,SampleMecanumDrive.getVelocityConstraint(70, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        Trajectory traj3 = drive.trajectoryBuilder(traj2.end())
                .splineTo(new Vector2d(50,48),Math.toRadians(270),SampleMecanumDrive.getVelocityConstraint(70, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory traj5 = drive.trajectoryBuilder(traj4.end())
                        .splineTo(new Vector2d(51.5,51.5),Math.toRadians(45),SampleMecanumDrive.getVelocityConstraint(60, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                                .build();
