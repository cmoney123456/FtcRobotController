...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 0.018; // = 0.023 / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = 57.2958; //Math.toRadians(60);
    public static double MAX_ANG_ACCEL = Math.toRadians(57.2958);
