...
@Autonomous
public class redLeftAscent extends LinearOpMode {
...
*/
        ...
        Trajectory traj12 = drive.trajectoryBuilder(traj9.end())
                .strafeRight(6,SampleMecanumDrive.getVelocityConstraint(70, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
