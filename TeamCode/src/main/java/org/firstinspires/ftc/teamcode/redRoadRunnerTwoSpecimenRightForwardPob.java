...
@Autonomous(name = "Forward Prob", group = "A")
public class redRoadRunnerTwoSpecimenRightForwardPob extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPos)
                        .back(6,SampleMecanumDrive.getVelocityConstraint(80, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
