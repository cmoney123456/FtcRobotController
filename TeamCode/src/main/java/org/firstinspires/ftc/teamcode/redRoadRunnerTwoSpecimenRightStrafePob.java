...
@Autonomous(name = "Strafe Prob", group = "A")
public class redRoadRunnerTwoSpecimenRightStrafePob extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPos)
                        .strafeRight(6,SampleMecanumDrive.getVelocityConstraint(80, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
